  ...
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <select class="form-control" id="activity_type" name="activity_type">
        ...
        <option value="product_added" {{ request('activity_type') == 'product_added' ? 'selected' : '' }}>Product added</option>
        <option value="product_edited" {{ request('activity_type') == 'product_edited' ? 'selected' : '' }}>Product edited</option>
        <option value="product_deleted" {{ request('activity_type') == 'product_deleted' ? 'selected' : '' }}>Product deleted</option>
      </select>
    </div> 
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="4">No product activities found.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
