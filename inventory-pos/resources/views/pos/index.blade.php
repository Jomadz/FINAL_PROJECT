                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-grid gap-2 mt-3">
                                <button class="btn btn-primary" onclick="openPaymentModal()">Place Order</button>
...
<script>
    ...
    console.log('Cart before submission:', cart);
        ...
        $.ajax({
            url: '/pos/submit-sale',  // Adjust the URL for the sale recording endpoint
            method: 'POST',
            contentType: 'application/json', // Important for JSON body
    data: JSON.stringify(saleData), // Convert to JSON string
    headers: {
        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
            ...
            success: function(response) {
                ...
                cart = [];  // Reset cart after successful submission
    ...
    function printReceipt() {
        alert('Receipt printed (this is a placeholder).');
    }
